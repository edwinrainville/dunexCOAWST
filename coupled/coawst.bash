...
export   MY_ROOT_DIR=/gscratch/derakhti/users/ej/COAWST
export   MY_PROJECT_DIR=/gscratch/derakhti/users/ej/dunexCOAWST/coupled
...
#export              FORT=pgi
 ...
 export   USE_PARALLEL_IO=              # Parallel I/O with Netcdf-4/HDF5
