...
!                                                                      !
!                                                                      !
!  rurol2d      2D  roller stress in XI-direction.                  !
!  rvrol2d      2D  roller stress in ETA-direction.                 !
!  rubrk2d      2D  breaking stress in XI-direction.                !
!  rvbrk2d      2D  breaking stress in ETA-direction.               !
!  rukvf2d      2D  K-stress in XI-direction.                       !
!  rvkvf2d      2D  K-stress in ETA-direction.                      !
!  rubst2d      2D  bottom streaming XI-direction.                  !
!  rvbst2d      2D  bottom streaming ETA-direction.                 !
!  russt2d      2D  surface streaming XI-direction.                 !
!  rvsst2d      2D  surface streaming ETA-direction.                !
!=======================================================================
!
        USE mod_kinds
        implicit none
