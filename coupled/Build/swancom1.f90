...
!                     sending/receiving with 1
!     IARR      1D    help array of type integer for 1 communication
!     ARR       1D    help array of type real for 1 communication
...
!
     ...
     &        JSD, JED, IE, INCI, III, LSTCP                              40.31
!JAC      INTEGER ISWP
!JAC
...
!
!TIMG!1        CALL SWTSTA(213)
        DO J = 1, MCMVAR
           CALL SWEXCHG( COMPDA(1,J), KGRPNT )
!JAC!1           CALL SWEXCHG( COMPDA(1,J), 0, KGRPNT )
        ENDDO
!TIMG!1        CALL SWTSTO(213)
        IF (STPNOW()) RETURN
!
!----------------------------------------------------------------------   40.22
