...
!
     ...
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (FoundError(exit_flag, NoError, 1942, MyFile)) RETURN
!
...
!
     ...
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (FoundError(exit_flag, NoError, 2100, MyFile)) RETURN
      Vinfo( 1)='Tcoef'
     ...
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (FoundError(exit_flag, NoError, 2115, MyFile)) RETURN
!
!  Various parameters.
!
!
