...
!
        ...
        character (len=80)  :: my_fc = "/sw/openmpi-2.0.2_icc-17/bin/mpif90"
        character (len=512) :: my_fflags = "-no-heap-arrays -fp-model precise -ip -O3 -traceback -assume byterecl -I/gscratch/derakhti/shared/MCT/include -free -free"
!
        character (len=256) :: Adir = "/gscratch/derakhti/users/ej/dunexCOAWST/coupled"
        character (len=256) :: Hdir = "/gscratch/derakhti/users/ej/dunexCOAWST/coupled"
        character (len=256) :: Hfile = "dunex.h"
        character (len=256) :: Rdir = "/gscratch/derakhti/users/ej/COAWST"
!
